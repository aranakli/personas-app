...
class MunicipioController extends Controller
{
    ...
    {
        //Despliega todos los municipios
    ...
    {
        //Guarda los cambios del municipio
        //El codigo del municipio es autoincremental
